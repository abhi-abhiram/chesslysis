...
//  MlModule
//
//  Created by Anukoola abhiram on 15/04/24.
//
...
class Labeling{
    ...
    func labelImage(image:UIImage,observations:[ProcessedObservation]) -> UIImage?{
        ...
        for observation in observations{
            let labelColor = UIColor(red: CGFloat.random(in: 0...1), green: CGFloat.random(in: 0...1), blue: CGFloat.random(in: 0...1), alpha: 1).cgColor
    ...
    let labels = ["B", "K", "N", "P", "Q", "R", "b","k", "n", "p", "q","r"]
